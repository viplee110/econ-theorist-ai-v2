...
class RouteRegistryTests(unittest.TestCase):
    ...
    def test_v1_through_v7_are_historical_and_v8_is_active(self) -> None:
        ...
        self.assertEqual(active.registry_version, 8)
        self.assertEqual(registry_hash(active), ROUTE_REGISTRY_V8_HASH)

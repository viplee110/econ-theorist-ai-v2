...
The first implementation adds a noncanonical framing-team module, three thin
host transitions, and focused tests. It must not modify frozen Phase 1--4
...
The existing `etai codex invoke` bridge now exposes three host-only team
transitions: open the bounded team, publish three raw advisory drafts, and
apply one direct user turn. It verifies the exact public delivery, current
